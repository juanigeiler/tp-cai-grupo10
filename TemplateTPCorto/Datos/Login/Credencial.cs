...
namespace Datos
{
    public class Credencial
    {
        ...
        public bool EsPrimerLogin { get => _esPrimerLogin; set => _esPrimerLogin = value; }
        ...
        public Credencial(String registro)
        {
            ...
            if (string.IsNullOrEmpty(datos[4].Trim()))
            {
                this._esPrimerLogin = true;
                this._fechaUltimoLogin = DateTime.MinValue;
            }
            else
            {
                this._esPrimerLogin = false;
